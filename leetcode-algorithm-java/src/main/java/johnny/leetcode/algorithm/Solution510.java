...
public class Solution510 {
    public Node inorderSuccessor(Node x) {
        ...
        Node cur = x;
        // case 1 : if you have right subtree
        if (cur.right != null) {
            cur = cur.right;
            while (cur.left != null) {
                cur = cur.left;
        ...
        // case 2: if you have to go up to get the successor
        // The idea is to find a parent that is the left child of its parent
        while (cur.parent != null && cur.parent.left != cur) {
            cur = cur.parent;
        }
        // here either you are at the root, or you have found a parent who has a left child
