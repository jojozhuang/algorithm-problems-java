...
public class Solution119Test {
    ...
    public void testGetRow() {
        ...
        List<Integer> expect2 = ListUtil.buildList(new Integer[]{1,1});
        assertEquals(expect2,  instance.getRow(1));

        List<Integer> expect3 = ListUtil.buildList(new Integer[]{1,2,1});
        assertEquals(expect3,  instance.getRow(2));

        List<Integer> expect4 = ListUtil.buildList(new Integer[]{1,3,3,1});
