...
import johnny.algorithm.leetcode.Solution015;
import johnny.algorithm.leetcode.common.ListUtil;

public class Solution015Test extends JunitBase {
    ...
    public void testThreeSum() {
        ...
        List<List<Integer>> expect1 = ListUtil.buildList2(new Integer[][]{{-1,-1,2},{-1,0,1}});
        assertEquals(expect1, result1);

        List<List<Integer>> result2 = instance.threeSum(new int[]{0,0,0,0});
        List<List<Integer>> expect2 = ListUtil.buildList2(new Integer[][]{{0,0,0}});
        assertEquals(expect2, result2);

        List<List<Integer>> result3 = instance.threeSum(new int[]{1,Integer.MAX_VALUE,Integer.MIN_VALUE,-1,0});
        List<List<Integer>> expect3 = ListUtil.buildList2(new Integer[][]{{Integer.MIN_VALUE, 1, Integer.MAX_VALUE},{-1,0,1}});
