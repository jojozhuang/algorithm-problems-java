...
public class Solution107Test {
    ...
    public void testLevelOrderBottom() {
        ...
        List<Integer> sub81 = new ArrayList();
        sub81.add(5);
        ret8.add(sub81);
        List<Integer> sub82 = new ArrayList();
        sub82.add(2);
        sub82.add(-5);
        ret8.add(sub82);
        List<Integer> sub83 = new ArrayList();
        sub83.add(-9);
        sub83.add(-8);
        ret8.add(sub83);
        List<Integer> sub84 = new ArrayList();
        sub84.add(-3);
        sub84.add(-2);
        ret8.add(sub84);
        List<Integer> sub85 = new ArrayList();
        sub85.add(0);
        ret8.add(sub85);
