...
public class Solution247Test {
    ...
    public void testFindStrobogrammatic() {
        ...
        List<String> expResult2 = new ArrayList(Arrays.asList("0", "1","8"));
        assertEquals(expResult2, instance.findStrobogrammatic(1));
        
        List<String> expResult3 = new ArrayList(Arrays.asList("11", "69","88", "96"));
        assertEquals(expResult3, instance.findStrobogrammatic(2));
        
        List<String> expResult4 = new ArrayList(Arrays.asList("101", "609","808", "906","111", "619","818", "916", "181", "689","888", "986"));
        assertEquals(expResult4, instance.findStrobogrammatic(3));
        
        List<String> expResult5 = new ArrayList(Arrays.asList("1001", "6009","8008", "9006","1111", "6119","8118", "9116","1691", "6699","8698", "9696","1881", "6889","8888", "9886","1961", "6969","8968", "9966"));
