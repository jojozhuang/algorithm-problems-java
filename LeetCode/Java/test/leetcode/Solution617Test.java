...
public class Solution617Test {
    ...
    public void testMergeTrees() {
        ...
        assertTrue(TreeNode.isSameValueTree(t12, instance.mergeTrees(t11, t12)));
        
        TreeNode t21 = TreeNode.CreateInstance(new String[] {"2"});
        TreeNode t22 = null;
        assertTrue(TreeNode.isSameValueTree(t21, instance.mergeTrees(t21, t22)));
        ...
        assertTrue(TreeNode.isSameValueTree(res3, instance.mergeTrees(t31, t32)));
        ...
        assertTrue(TreeNode.isSameValueTree(res4, instance.mergeTrees(t41, t42)));
        ...
        assertTrue(TreeNode.isSameValueTree(res5, instance.mergeTrees(t51, t52)));
