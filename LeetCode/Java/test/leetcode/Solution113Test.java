...
public class Solution113Test {
    ...
    public void testPathSum() {
        ...
        list61.add(3);
        list61.add(4);
        List<List<Integer>> expResult6 = new ArrayList();
        ...
        list71.add(-2);
        list71.add(-3);
        List<List<Integer>> expResult7 = new ArrayList();
        ...
        list82.add(4);
        list82.add(5);
        List<List<Integer>> expResult8 = new ArrayList();
        ...
        list91.add(1);
        list91.add(-1);
        List<List<Integer>> expResult9 = new ArrayList();
