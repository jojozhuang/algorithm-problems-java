 ...
 * 1. You can rotate the ring clockwise or anticlockwise one place, which counts
 ...
 * the character key[i].
 * 2. If the character key[i] has been aligned at the 12:00 direction, you need 
 * to press the center button to spell, which also counts as 1 step. After the
